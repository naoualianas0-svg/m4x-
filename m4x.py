...
"""
    ...
    utils.print(f'{G}[>] {C}Created By   : {W}0 0 1')
    utils.print(f'{G} |---> {C}Discord   : {W}https://discord.gg/NY2eBCDWK')
    utils.print(f'{G} |---> {C}Team M 4 X : {W}Test is on')
    utils.print(f'{G}[>] {C}Version      : {W}1.0.0\n')
